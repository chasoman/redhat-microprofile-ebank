...
public class InvolvedPartyDetailsResource {
	...
	/*
	 * TODO
	 * Using annotations only, inject the value as defined in the microprofile-config.properties file.
	 * A default value of 8085 should also be specified in the annotation.
	 */
