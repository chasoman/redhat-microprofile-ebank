...
public class InvolvedPartyDetailsResource {
	...
	/* TODO - Exercise 1
	 	1. Using the correct Fault Tolerance annotation, ensure that the call does not wait forever 
	 	   for a response and should give up after 10 seconds. 
	 	   Note: the wait time is in seconds
	*/
	@GET
