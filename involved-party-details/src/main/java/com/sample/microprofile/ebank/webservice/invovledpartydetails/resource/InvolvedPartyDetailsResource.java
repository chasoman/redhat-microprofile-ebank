...
public class InvolvedPartyDetailsResource {
	...
	/*
	 * TODO
	 * 1. Create a private Config object with the name as config (instance variable name is in small case)
	 * 2. Annotate this variable with @Inject annotation
	 */ 
	...
	private Response invokeDependentServices(String involvedPartyId) {
			...
			/*TODO
			 * 1. Fill in the RHS of the assignment to arrangementPort instance variable.
			 * 2. Use injected config object to call the getValue method on it. 
			 * 3. Retrieve the arrangementPort property where the PropertyType is a String.
			 */
			arrangementPort = // to complete based on above TODO
